...
def findAntinodes(a1, a2):
    ...
    while (
        ...
        xDistanceRatio = abs(a1[1] - testX) / abs(a2[1] - testX)
        yDistanceRatio = abs(a1[0] - testY) / abs(a2[0] - testY)
        if (xDistanceRatio == 0.5 and yDistanceRatio == 0.5) or (
            xDistanceRatio == 2 and yDistanceRatio == 2
        ):
